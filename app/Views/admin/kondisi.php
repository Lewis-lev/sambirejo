...
<body>
    ...
    <div class="grid">
                ...
                <?php $counter = 1; foreach ($pesanan as $row): ?>
                        <tr>
                            ...
                            <td style="text-align: center;" class="status">
                                <?php 
                                    if ($row['kondisi']==1) {
                                        echo '<a href="kondisi/kondisi/'.$row['id'].'" class="btn btn-success">Sudah berkunjung</a>';
                                    } else {
                                        echo '<a href="kondisi/kondisi/'.$row['id'].'" class="btn btn-danger">Belum berkunjung</a>';
                                    }
                                    
                                ;?>
                            </td>
                            <td>
                                <a href="kondisi/delete/<?= $row['id'] ;?>" class="btn btn-danger"><i class="fa fa-trash" style="font-size:20px;"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <a href="kondisi/deleteAll" class="btn btn-danger center">Delete All</a>
