...
<body>
    ...
    <div class="grid">
                ...
                <?php $counter = 1; foreach ($pesanan as $row): ?>
                        <tr>
                            ...
                            <td style="text-align: center;" class="status">
                                <?php 
                                    if ($row['status']==1) {
                                        echo '<a href="status/status/'.$row['id'].'" class="btn btn-success">Sudah bayar</a>';
                                    } else {
                                        echo '<a href="status/status/'.$row['id'].'" class="btn btn-danger">Belum bayar</a>';
                                    }
                                    
                                ;?>
                            </td>
                            <td>
                                <a href="status/delete/<?= $row['id'] ;?>" class="btn btn-danger"><i class="fa fa-trash" style="font-size:20px;"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <a href="status/deleteAll" class="btn btn-danger center">Delete All</a>
